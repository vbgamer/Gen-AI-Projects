I created a simple API using Flask. Then I used the "self-refine" technique by adding prompt-style comments in my code asking ChatGPT to improve things like performance, error handling, and formatting.
